import { areaChart, columns, listChecks, server, table } from '@vitral/icons';
...
createApp(App)
    .use(Vitral, {
        ...
        // landing page, three for the addons menu.
        icons: [listChecks, server, areaChart, columns, table]
    })
    .mount('#app');
