...
<template>
    <p>
        A component never holds a string. Everything it says — “Clear”, “No results”, the month names, the page report, the name of the close button — comes from the locale in the
        configuration, and the configuration is reactive, so changing it changes the page.
    </p>
    ...
    <ul>
        ...
        <li><strong>Messages</strong> with placeholders go through <code>formatMessage</code> — <code>'{first} to {last} of {total}'</code>.</li>
    </ul>
</template>
