...
export const datatableStyle = defineStyle({
    ...
    classes: {
        ...
        headerCell: (s: DataTableHeaderCellState) => ['vt-datatable-header-cell', { 'vt-datatable-header-cell-sortable': s.sortable, 'vt-datatable-header-cell-sorted': s.sorted }, align(s)],
        ...
        filterCell: (s: DataTableCellState) => ['vt-datatable-filter-cell', align(s)],
        ...
        bodyCell: (s: DataTableCellState) => ['vt-datatable-body-cell', align(s)],
        ...
        footerCell: (s: DataTableCellState) => ['vt-datatable-footer-cell', align(s)],
